...
public:
  StyleSelector() {
    frameImg =
        juce::ImageCache::getFromMemory(UIAssets::ui_panel_style_selector_frame_base_v001_png,
                                        UIAssets::ui_panel_style_selector_frame_base_v001_pngSize);

    techButton =
        std::make_unique<ImageToggleButton>("Tech", UIAssets::ui_style_mode_tech_idle_v001_png,
    ...
    neuroButton =
        std::make_unique<ImageToggleButton>("Neuro", UIAssets::ui_style_mode_neuro_idle_v001_png,
    ...
    darkButton =
        std::make_unique<ImageToggleButton>("Dark", UIAssets::ui_style_mode_dark_idle_v001_png,
  ...
  void resized() override {
    ...
    techButton->setBounds(bounds.removeFromLeft(w).reduced(6));
    neuroButton->setBounds(bounds.removeFromLeft(w).reduced(6));
    darkButton->setBounds(bounds.reduced(6));
  }

  juce::ToggleButton &getTechButton() {
    return *techButton;
  }
  juce::ToggleButton &getNeuroButton() {
    return *neuroButton;
  }
  juce::ToggleButton &getDarkButton() {
    return *darkButton;
  }
